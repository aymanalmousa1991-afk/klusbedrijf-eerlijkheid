...
const items = [
    { icon: Phone, labelKey: "contact.phone_label", value: "06 8193 2710", href: "tel:0681932710" },
    { icon: Mail, labelKey: "contact.email_label", value: "0912azza0jabr@gmail.com", href: "mailto:0912azza0jabr@gmail.com" },
    { icon: MapPin, labelKey: "contact.region_label", valueKey: "contact.region_value", href: null },
    { icon: Clock, labelKey: "contact.available_label", valueKey: "contact.available_value", href: null },
];
                    ...
                    <div className="relative grid lg:grid-cols-12 gap-10">
                        <div className="lg:col-span-6">
                            ...
                            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl tracking-tight leading-[1.05]">
                                {t("contact.title1")} <br />
                                <span className="text-[#60A5FA]">{t("contact.title2")}</span>.
                            </h2>
                        ...
                        <div className="lg:col-span-6 grid sm:grid-cols-2 gap-4">
                            {items.map((it, i) => {
                                ...
                                const displayValue = it.valueKey ? t(it.valueKey) : it.value;
                                return (
                                    <Wrapper
                                        key={i}
                                        {...props}
                                    ...
                                    >
                                        ...
                                        <div className="text-xs text-gray-400 mb-1.5">{t(it.labelKey)}</div>
